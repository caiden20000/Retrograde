...
const abandoned_cargo__node1: EncounterNode = {
  ...
  options: [
  {
      label: "Open it",
      outcomes: [
        { chance: 0.5, node: abandoned_cargo__node1_1, nodeType: "EncounterNode" },
        { chance: 0.5, node: abandoned_cargo__node1_2, nodeType: "EncounterNode" }
      ]
    },
  {
      label: "Leave it be",
...
const distress_beacon__node2: EncounterNode = {
  ...
  options: [
  {
      ...
      outcomes: [
        { chance: 0.5, node: distress_beacon__node2s, nodeType: "EncounterNode" },
        { chance: 0.5, node: distress_beacon__node2f, nodeType: "EncounterNode" }
      ]
    },
  {
...
const goodguy1__root: EncounterNode = {
  ...
  options: [
  {
      ...
      outcomes: [
        { chance: 0.5, node: goodguy1__root_s, nodeType: "EncounterNode" },
        { chance: 0.5, node: goodguy1__root_f, nodeType: "EncounterNode" }
      ]
    },
  {
      label: "Ignore them",
...
After initiating comms, the captain explains they are out of fuel.`,
  ...
  options: [
  {
      ...
      outcomes: [
        { chance: 0.3333333333333333, node: goodguy2__root_s1, nodeType: "EncounterNode" },
        { chance: 0.3333333333333333, node: goodguy2__root_s2, nodeType: "EncounterNode" },
        { chance: 0.3333333333333333, node: goodguy2__root_f, nodeType: "EncounterNode" }
      ]
    },
  {
      label: "Provide nothing",
      outcomes: [
        { chance: 0.5, node: goodguy2__leave1, nodeType: "EncounterNode" },
        { chance: 0.5, node: goodguy2__leave2, nodeType: "EncounterNode" }
      ]
    }
  ]
};

const hitchhiker__root_s: EncounterNode = {
  description: `You let them into the airlock and onto your ship. The hitchhiker is so thankful that he transfers you some money!`,
  sideEffect: newSideEffect({ namedEffects: ["smallReward" ] }),
  options: [
  {
      label: "Generous!",
...
const hitchhiker__root_f: EncounterNode = {
  description: `You let them into the airlock and onto your ship. The hitchhiker thanks you for your kindness.`,
  sideEffect: null,
  options: [
  {
      label: "No problem!",
...
const hitchhiker__root_f2: EncounterNode = {
  description: `You let them into the airlock and onto your ship. The hitchhiker thanks you for your kindness.
When he finally leaves the ship, however, you notice a considerable amount of money missing!`,
  sideEffect: newSideEffect({ namedEffects: ["smallTheft" ] }),
  options: [
  {
      label: "I've been robbed!",
      outcomes: [
        { chance: 1, node: null, nodeType: "null" }
      ]
    }
...
const hitchhiker__leave: EncounterNode = {
  description: `You bluff, saying there's no room in the ship.
...
const hitchhiker__root: EncounterNode = {
  description: `As you fly to your destination, you are surprised to see a person floating out in space.
When you open comms with them, they explain they are hitchhiking in the direction you are flying.`,
  ...
  options: [
  {
      label: "Pick them up",
      outcomes: [
        { chance: 0.3333333333333333, node: hitchhiker__root_s, nodeType: "EncounterNode" },
        { chance: 0.3333333333333333, node: hitchhiker__root_f, nodeType: "EncounterNode" },
        { chance: 0.3333333333333333, node: hitchhiker__root_f2, nodeType: "EncounterNode" }
      ]
    },
  {
      label: "Leave them",
      outcomes: [
        { chance: 1, node: hitchhiker__leave, nodeType: "EncounterNode" }
      ]
    }
  ]
};

export const allRootNodes = [abandoned_cargo__node1, distress_beacon__node1, goodguy1__root, goodguy2__root, hitchhiker__root];
