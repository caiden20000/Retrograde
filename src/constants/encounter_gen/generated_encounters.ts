  ...
  options: [
    {
      ...
      outcomes: [
        {
          chance: 0.5,
          node: distress_beacon__node2s,
          nodeType: "EncounterNode",
        },
        {
          chance: 0.5,
          node: distress_beacon__node2f,
          nodeType: "EncounterNode",
        },
      ],
    },
...
const goodguy1__root: EncounterNode = {
  ...
  options: [
    ...
    {
      label: "Ignore them",
      outcomes: [{ chance: 1, node: goodguy1__end, nodeType: "EncounterNode" }],
    },
  ],
};
      ...
      outcomes: [
        {
          ...
          node: goodguy2__root_s1,
          nodeType: "EncounterNode",
        },
        {
          chance: 0.3333333333333333,
          node: goodguy2__root_s2,
          nodeType: "EncounterNode",
        },
        {
          chance: 0.3333333333333333,
          node: goodguy2__root_f,
          nodeType: "EncounterNode",
        },
      ],
    },
...
export const allRootNodes = [
  abandoned_cargo__node1,
  distress_beacon__node1,
  goodguy1__root,
  goodguy2__root,
];
